...
<body>
    ...
    <main>
        <!-- 카드 -->
        <div class="card">
            <img src="/view/img/memo_1.png" class="card-img-top" alt="메모">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                    card's content.</p>
                <button href="#" class="btn btn-primary" data-bs-toggle="modal"
                    data-bs-target="#modal-detail">상세</button>
            </div>
        </div>
        <div class="card">
            <img src="/view/img/memo_2.png" class="card-img-top" alt="메모">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                    card's content.</p>
        ...
        <div class="card">
            <img src="/view/img/memo_3.png" class="card-img-top" alt="메모">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                    card's content.</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="">
                    ...
                    <div class="modal-body">
                        <textarea class="form-control" cols="30" rows="10" placeholder="내용을 입력하세요"
