...
// PDO::errorCode : DB Handle에서 마지막 작업과 관련된 SQLSTATE(DB Error Code)를 리턴
// PDO::errorInfo : DB Handle에서 마지막 작업과 관련된 에러 정보를 리턴
// PDO::query : placeholder 셋팅 없이 SQL 문을 준비하고 실행
// PDO::prepare : 실행할 문을 준비하고 PDOStatement객체를 반환
// PDO::exec : SQL 문을 실행하고 영향을 받은 행의 수를 반환
// PDO::lastInsertId : 마지막으로 삽입된 행 또는 시퀀스 값의 ID를 반환
